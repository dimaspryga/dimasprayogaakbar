...
export default function Home() {
  ...
  return (
    <div className="min-h-screen pt-16 bg-background font-inter">
      ...
      {/* Areas of Expertise */}
      <section className="py-16 border-t bg-slate-100 dark:bg-gray-900 border-slate-200 dark:border-gray-800">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <Marquee speed={30} className="py-3">
              {techStackLogos.map((tech, index) => (
                <div key={index} className="flex items-center mx-4 space-x-2 whitespace-nowrap">
                  ...
                  <span className="text-sm font-medium text-slate-700 dark:text-gray-300">{tech.name}</span>
                </div>
              ))}
            </Marquee>
          </motion.div>
